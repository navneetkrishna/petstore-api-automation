...
from util.assertions import assert_status, assert_field_not_empty
...
class TestUserAuth:
    ...
    @pytest.mark.smoke
    def test_usr_a001_login_valid_credentials(self, user_service, created_user):
    ...
    def test_usr_a002_login_invalid_credentials(self, user_service):
    ...
    @pytest.mark.negative
    def test_usr_a003_login_empty_credentials(self, user_service):
    ...
    @pytest.mark.smoke
    def test_usr_a004_logout_after_login(self, user_service, created_user):
    ...
    def test_usr_a005_logout_without_login(self, user_service):
    ...
    def test_usr_a006_login_response_contains_token_header(self, user_service, created_user):
